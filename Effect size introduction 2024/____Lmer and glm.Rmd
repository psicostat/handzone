...
The linear increase *per year* is about +**`r format(round(linearincrease,2),nsmall=2)`** correctly solved math problems... this is not incorrect, but clearly inaccurate when close to the bounds.
